  ...
  return (
    ...
    >
      <motion.img
        ...
        style={{ y }}
      />
      <div className="w-full lg:w-auto fixed top-4 px-2 z-[100] left-1/2 -translate-x-1/2">
        <nav className="flex items-center whitespace-nowrap justify-start gap-4 lg:gap-12 text-white ring-1 ring-white/50 text-xs lg:text-sm py-0 px-4 snap-x overflow-x-auto shadow-lg bg-gray/80 backdrop-blur-md rounded-lg">
