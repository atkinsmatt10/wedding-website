  ...
  return (
    <main role="main">
      ...
      <section id="schedule" className="relative py-12">
        ...
        <div className="grid place-items-center gap-20 mt-20">
          <div className="max-w-sm col-start-1">
          ...
          <div className="max-w-sm row-start-2 col-start-2">
            <h4 className="text-lg font-bold before:content-['❤︎'] before:absolute before:-translate-x-full before:-ml-4">
              The Ceremony
            </h4>
            <span className="text-sm font-bold text-gold mb-4 block">
          ...
          <div className="max-w-sm row-start-3 col-start-1">
            <h4 className="text-lg font-bold before:content-['❤︎'] before:absolute before:-translate-x-full before:-ml-4">
              Coctail Hour
            </h4>
            <span className="text-sm font-bold text-gold mb-4 block">
          ...
          <div className="max-w-sm row-start-4 col-start-2">
            <h4 className="text-lg font-bold before:content-['❤︎'] before:absolute before:-translate-x-full before:-ml-4">
              Reception
            </h4>
            <span className="text-sm font-bold text-gold mb-4 block">
